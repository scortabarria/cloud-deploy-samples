...
func TestPipelineRequestFromManifestSuccess(t *testing.T){
	...
	cont, err := pipelineRequestFromManifest("/usr/local/google/home/scortabarria/Desktop/cloud-deploy-samples/custom-targets/vertex-ai-pipeline/workspace/source/test.text")
	if err == nil {
		t.Errorf("Expected: error, Actual: %s", err, )
	}

	cont, err = pipelineRequestFromManifest("/usr/local/google/home/scortabarria/Desktop/cloud-deploy-samples/custom-targets/vertex-ai-pipeline/workspace/source/test.yaml")
